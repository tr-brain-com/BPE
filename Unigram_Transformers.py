...
print(encode_word("kara", model))
print(encode_word("ankara", model))
...
print(tokenize("Bu bolumde bpe tokenizer algoritmasi gosterilmektedir.", model))
